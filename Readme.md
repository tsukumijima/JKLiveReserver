...
現在存在するコミュニティチャンネル全てで 24 時間常に実況枠を確保するのなら、**事実上プレミアム会員アカウントを持っている最低 19 人の協力が必要です。**
...
> 2022/03/21 現在、コミュニティチャンネルのうち tvk・チバテレビ・NHK BSプレミアム・BS日テレ・BS朝日・BS-TBS・BSテレ東・BSフジ・AT-X の 9 チャンネルで 24 時間全自動で枠取りが行われています。
...
- 番組の予約にはニコニコ側のユーザー生放送の制限がかかります。  
  ...
  - **同一時間帯に同じユーザーで複数のコミュニティの番組を予約することはできません。**
