...
現在存在するコミュニティチャンネル全てで 24 時間常に実況枠を確保するのなら、**事実上プレミアム会員アカウントを持っている最低 15 人の協力が必要です。**
...
> 2021/08/12 現在、コミュニティチャンネルのうち tvk・チバテレビ・NHK BSプレミアム・BS日テレ・BS朝日・BS-TBS・BSフジ・AT-X の 8 チャンネルで 24 時間全自動で枠取りが行われています。
